...
<h3 align="center">Deposit/Withdrawal Operation</h3>

<div id="accCnt">
	<div class="accRow">
	<div class="label" style="float: left;">Choose Account:</div>
	<div >
	...
	<div  class="accRow" style="margin-top: 10px;">
		<div class="label" style="float:left; padding-top: 5px; padding-right:10px; ">Transaction Type:</div>
		<div>
		<form:radiobutton path="transactionType" onclick="showButton()" id="credit" value="credit"/>Deposit
		<form:radiobutton path="transactionType" onclick="showButton()" id="debit" value="debit"/>Withdraw
		</div>
	</div>
